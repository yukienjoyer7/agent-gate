...
class AuditModelRegistrationTest(unittest.TestCase):
    def test_audit_model_is_registered_with_alembic_metadata(self) -> None:
        ...
        self.assertIn("browser_sessions", table_names)
        ...
        self.assertIn("browser_sessions", alembic_table_names)
        ...
        self.assertEqual(
            ["session_id", "created_at", "last_seen_at", "ended_at", "end_reason"],
            list(BrowserSession.__table__.columns.keys()),
        )
