...
| [service-contracts.md](service-contracts.md) | Earlier service-contract reference |
...
| Decisions (ADRs) | [0001 architecture foundation](decisions/0001-architecture-foundation.md), [0002 local-first CLI](decisions/0002-local-first-cli.md), [0003 embedded guardrail engine](decisions/0003-embedded-guardrail-engine.md), [0004 audit granularity](decisions/0004-audit-granularity.md) (proposed; would amend 0002's write-once audit) |
...
## Changelog
[CHANGELOG-atomic-browser-audit.md](CHANGELOG-atomic-browser-audit.md).
